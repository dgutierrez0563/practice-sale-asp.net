...
namespace LenguajesAvanzados.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDVendedor,Name,Apellido,FechaCreado")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDVendedor,Name,Apellido,FechaCreado")] Vendedor vendedor)
        {
            if (ModelState.IsValid)
            {
